...
#ifndef MALICIOUS_PPML_ALEXNETCONFIG_H
#define MALICIOUS_PPML_ALEXNETCONFIG_H
...
//    uint32_t conv3_out_channels;
    ...
    conv_in_channels = {3,96,256,384,256};
...
//        std::cout<< "output: "<<conv_out_channels[0]<<"\n";
    ...
    Convop[1].input_shape_ = {conv_in_channels[1],55,55};
    ...
    Convop[4].input_shape_ = {conv_in_channels[4],6,6};
    Convop[4].output_shape_ = {conv_out_channels[4],1,1};
...
#endif //MALICIOUS_PPML_ALEXNETCONFIG_H
