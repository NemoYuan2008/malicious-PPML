...
void InitializeConv(){
    ...
    for (int i = 0; i < layers; ++i) {
        ...
        Conv1op[i].input_shape_ = {conv1_in_channels,32,32};
        Conv1op[i].output_shape_ = {conv1_out_channels,32,32};
        ...
        Conv2op[i].input_shape_ = {conv2_in_channels,32,32};
        Conv2op[i].output_shape_ = {conv2_out_channels,32,32};
        ...
        Conv3op[i].input_shape_ = {conv3_in_channels,32,32};
        Conv3op[i].output_shape_ = {conv3_out_channels,32,32};
